...
class CreateSprCellsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('spr_cells', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('cell')->comment('����� ������');
