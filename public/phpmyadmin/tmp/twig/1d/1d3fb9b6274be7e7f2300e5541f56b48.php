...
class __TwigTemplate_dbe7e7f1d9e97868ee6db9543afbb3b4 extends Template
{
    private $source;
    private $macros = [];
...
") : (""));
      ...
      ";
            ...
            if (twig_in_filter(twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "pma_type", [], "any", false, false, false, 121), ($context["gis_data_types"] ?? null))) {
                ...
                echo twig_escape_filter($this->env, ($context["row_id"] ?? null), "html", null, true);
                echo "\">";
                echo PhpMyAdmin\Html\Generator::linkOrButton("#", PhpMyAdmin\Html\Generator::getIcon("b_edit", _gettext("Edit/Insert")), [], "_blank");
                echo "</span>
      ";
            }
            // line 124
...
";
    ...
    {
        return new Source("", "table/insert/column_row.twig", "D:\\Program Files\\Apache24\\htdocs\\kassa\\public\\phpmyadmin\\templates\\table\\insert\\column_row.twig");
    }
}
