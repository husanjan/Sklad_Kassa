...
class __TwigTemplate_8c05c00f2451d61a32459ce4407ece7e extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "D:\\Program Files\\Apache24\\htdocs\\kassa\\public\\phpmyadmin\\templates\\preferences\\header.twig");
    }
}
