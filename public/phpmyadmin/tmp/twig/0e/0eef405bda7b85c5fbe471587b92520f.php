...
class __TwigTemplate_5ebee511ea84d442471e054582a957ac extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Delete data or table");
    ...
    <ul class=\"list-group list-group-flush\">
      ";
          ...
          ";
                // line 407
                echo PhpMyAdmin\Html\Generator::linkOrButton(PhpMyAdmin\Url::getFromRoute("/sql", twig_array_merge(                // line 408
($context["url_params"] ?? null), ["sql_query" => ((("TRUNCATE TABLE " . PhpMyAdmin\Util::backquote(                // line 409
($context["db"] ?? null))) . ".") . PhpMyAdmin\Util::backquote(($context["table"] ?? null))), "goto" => PhpMyAdmin\Url::getFromRoute("/table/structure"), "reload" => true, "message_to_show" => twig_escape_filter($this->env, twig_sprintf(_gettext("Table %s has been emptied."),                 // line 412
($context["table"] ?? null)))])), _gettext("Empty the table (TRUNCATE)"), ["id" => "truncate_tbl_anchor", "class" => "text-danger ajax", "data-query" => ((("TRUNCATE TABLE " . PhpMyAdmin\Util::backquote(                // line 418
($context["db"] ?? null))) . ".") . PhpMyAdmin\Util::backquote(($context["table"] ?? null)))]);
        ...
        <li class=\"list-group-item\">
          ";
                // line 424
                echo PhpMyAdmin\Html\Generator::linkOrButton(PhpMyAdmin\Url::getFromRoute("/sql", twig_array_merge(                // line 425
($context["url_params"] ?? null), ["sql_query" => ((("DELETE FROM " . PhpMyAdmin\Util::backquote(                // line 426
($context["db"] ?? null))) . ".") . PhpMyAdmin\Util::backquote(($context["table"] ?? null))), "goto" => PhpMyAdmin\Url::getFromRoute("/table/structure"), "reload" => true, "message_to_show" => twig_escape_filter($this->env, twig_sprintf(_gettext("Table %s has been emptied."),                 // line 429
($context["table"] ?? null)))])), _gettext("Empty the table (DELETE FROM)"), ["id" => "delete_tbl_anchor", "class" => "text-danger ajax", "data-query" => ((("DELETE FROM " . PhpMyAdmin\Util::backquote(                // line 435
($context["db"] ?? null))) . ".") . PhpMyAdmin\Util::backquote(($context["table"] ?? null)))]);
                // line 437
                echo "
          ";
      ...
      ";
        ...
        ";
            // line 442
            echo PhpMyAdmin\Html\Generator::linkOrButton(PhpMyAdmin\Url::getFromRoute("/sql", twig_array_merge(            // line 443
($context["url_params"] ?? null), ["sql_query" => ((("DROP TABLE " . PhpMyAdmin\Util::backquote(            // line 444
($context["db"] ?? null))) . ".") . PhpMyAdmin\Util::backquote(($context["table"] ?? null))), "goto" => PhpMyAdmin\Url::getFromRoute("/database/operations"), "reload" => true, "purge" => true, "message_to_show" => ((            // line 448
($context["is_view"] ?? null)) ? (twig_escape_filter($this->env, twig_sprintf(_gettext("View %s has been dropped."), ($context["table"] ?? null)))) : (twig_escape_filter($this->env, twig_sprintf(_gettext("Table %s has been dropped."), ($context["table"] ?? null))))), "table" =>             // line 449
($context["table"] ?? null)])), _gettext("Delete the table (DROP)"), ["id" => "drop_tbl_anchor", "class" => "text-danger ajax", "data-query" => ((("DROP TABLE " . PhpMyAdmin\Util::backquote(            // line 455
($context["db"] ?? null))) . ".") . PhpMyAdmin\Util::backquote(($context["table"] ?? null)))]);
            // line 457
            echo "
        ";
...
echo _gettext("Partition");
          ...
          <select class=\"form-control resize-vertical\" id=\"partition_name\" name=\"partition_name[]\" multiple required>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["partition"]) {
                ...
                echo "\"";
                echo ((twig_get_attribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, false, 480)) ? (" selected") : (""));
                echo ">";
                echo twig_escape_filter($this->env, $context["partition"], "html", null, true);
                echo "</option>
            ";
        ...
        <div class=\"form-text\">
          <a href=\"";
            // line 495
            echo PhpMyAdmin\Url::getFromRoute("/sql", twig_array_merge(($context["url_params"] ?? null), ["sql_query" => (("ALTER TABLE " . PhpMyAdmin\Util::backquote(            // line 496
    ...
    <ul class=\"list-group list-group-flush\">
      ";
          ...
          <a class=\"text-nowrap\" href=\"";
                // line 514
                echo PhpMyAdmin\Url::getFromRoute("/sql", twig_get_attribute($this->env, $this->source, $context["foreign"], "params", [], "any", false, false, false, 514));
                echo "\">
            ";
                // line 515
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["foreign"], "master", [], "any", false, false, false, 515), "html", null, true);
                echo " -> ";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["foreign"], "db", [], "any", false, false, false, 515), "html", null, true);
                echo ".";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["foreign"], "table", [], "any", false, false, false, 515), "html", null, true);
                echo ".";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["foreign"], "field", [], "any", false, false, false, 515), "html", null, true);
                echo "
          </a>
        </li>
      ";
