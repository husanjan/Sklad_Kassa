...
echo _gettext("Query results operations");
    ...
    ";
            // line 267
            if ( !twig_get_attribute($this->env, $this->source, ($context["operations"] ?? null), "has_procedure", [], "any", false, false, false, 267)) {
                // line 268
                echo "      ";
                if (twig_get_attribute($this->env, $this->source, ($context["operations"] ?? null), "has_export_link", [], "any", false, false, false, 268)) {
                    // line 269
                    echo "        ";
                    echo PhpMyAdmin\Html\Generator::linkOrButton(PhpMyAdmin\Url::getFromRoute("/table/export", twig_get_attribute($this->env, $this->source,                     // line 270
($context["operations"] ?? null), "url_params", [], "any", false, false, false, 270)), PhpMyAdmin\Html\Generator::getIcon("b_tblexport", _gettext("Export"), true), ["class" => "btn"]);
                    // line 273
                    echo "

        ";
                    // line 275
                    echo PhpMyAdmin\Html\Generator::linkOrButton(PhpMyAdmin\Url::getFromRoute("/table/chart", twig_get_attribute($this->env, $this->source,                     // line 276
($context["operations"] ?? null), "url_params", [], "any", false, false, false, 276)), PhpMyAdmin\Html\Generator::getIcon("b_chart", _gettext("Display chart"), true), ["class" => "btn"]);
                    // line 279
                    echo "

        ";
                    // line 281
                    if (twig_get_attribute($this->env, $this->source, ($context["operations"] ?? null), "has_geometry", [], "any", false, false, false, 281)) {
                        // line 282
                        echo "          ";
                        echo PhpMyAdmin\Html\Generator::linkOrButton(PhpMyAdmin\Url::getFromRoute("/table/gis-visualization", twig_get_attribute($this->env, $this->source,                         // line 283
($context["operations"] ?? null), "url_params", [], "any", false, false, false, 283)), PhpMyAdmin\Html\Generator::getIcon("b_globe", _gettext("Visualize GIS data"), true), ["class" => "btn"]);
                        // line 286
                        echo "
        ";
                    }
      ...
      <span>
        ";
                // line 291
                echo PhpMyAdmin\Html\Generator::linkOrButton(PhpMyAdmin\Url::getFromRoute("/view/create", ["db" =>                 // line 292
