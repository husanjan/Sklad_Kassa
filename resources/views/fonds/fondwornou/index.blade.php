...
@section('content')
  ...
  <nav aria-label="breadcrumb ">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Фарсуда</li>
    </ol>
</nav>
  ...
  @endif
<form method="POST" action="{{ route('fondwornou.store') }}" id="submit" >
    @csrf
                      ...
                      <div class="tab-pane fade show active" id="One" role="tabpanel" aria-labelledby="home-tab">
                                   ...
                                   <div class="row  mt-2     " id="new00"  >
                                       ...
                                       <input     id="nominal01"  value="1"   class="nominal"  type="hidden"  name="nominal0[]"     >
                                        ...
                                        <input type="hidden" id="" name="summacounts0[]">
      ...
      <div class="container">
          <div class="col-md-12">
              <div class="btn-group" role="group" aria-label="Basic example">
                  ...
                  <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#farsuda" value="1">Расход</button>
