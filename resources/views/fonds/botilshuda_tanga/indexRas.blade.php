  ...
  <form method="POST" action="{{route('botilshuda_tanga.store')}}">
    ...
    <input     value="botilshuda"   name="acccounti" type="hidden">
    ...
    <div class="modal-dialog  modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Ботилшуда Танга</h5>
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <label for="" class="offset-md-9 mt-4">  <span class="badge badge-light text-black "><h6><b>Общие сумма : </b>{{$allsumbotilshudaTanga}}</h6></span> </label>
         ...
         <table class="table mt-2">
            ...
            <tbody>
              ...
              @endphp
                @foreach($botilshudaTanga AS  $ostatkiResults)
                ...
                <input type="hidden" name="id[]" value="{{$ostatkiResults->id}}">
                  <tr class="border-bottom" id="t{{$ostatkiResults->id}}">
                    ...
                    <td><input type="text" class="form-control col-md-4 summaRBotT"  name="Summarashod{{$ostatkiResults->id}}[]" id="{{$ostatkiResults->id}}"></td>
                </tr>
                  @endif
