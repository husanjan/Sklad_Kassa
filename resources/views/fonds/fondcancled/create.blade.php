...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ __('Добавление эмиссионный фонд') }}</div>
...
{{--                                        autocomplete="off"--}}
                                        <form role="form"   autocomplete="off" action="{{ route('fondemission.store') }}"  method="post">
                                            @csrf
                                            ...
                                            <div class="row mb-12">
                                                <label for="num" class="col-md-4 col-form-label text-md-end" >{{ __('Номер') }}</label>
                                                <div class="col-md-8">
                                                    <input id="num" type="text" class="form-control text" minlength="7" maxlength="7" required name="nn"  >
                                                </div>
                                            </div>         <br>
                                            <div class="row mb-3">
