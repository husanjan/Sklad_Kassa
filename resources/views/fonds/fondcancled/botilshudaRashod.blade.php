         ...
         <table class="table mt-2">
            ...
            <tbody>
              ...
              @endphp
                ...
                <td><input type="text" class="form-control col-md-4 summaRB"  name="Summarashod{{$ostatkiResults->id}}[]" id="{{$ostatkiResults->id}}"></td>
