...
@section('content')
  ...
  <nav aria-label="breadcrumb ">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Ботилшуда</li>
    </ol>
</nav>
              ...
              <div class="modal-body">
                  ...
                  <div class="row  offset-1">
                      ...
                      <div class="col-md-3  ">
                          ...
                          <input            name="farsuda" type="hidden"   id="farsuda" value="3" >
                                   ...
                                   <div class="row  mt-2     " id="new00"  >
                                       ...
                                       <input     id="nominal01"  value="1"   class="nominal"  type="hidden"  name="nominal0[]"     >
                                        ...
                                        <div class="col-md-1  ">
                                            ...
                                            <input      style="width: 05rem;" id="count01"   type="text" data-type="0" name="count0[]" class="form-control  Somon  count">
...
var counts= '  <div class="col-md-1  "><label for="count'+idv+new_btn+'">Кол-во	</label><input      style="width: 05rem;" id="count'+idv+new_btn+'" data-type="0"   type="text"  name="count'+idv+'[]" class="form-control Somon  count"></div>';
  // ..Хранилище тег
