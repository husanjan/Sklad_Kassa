...
@section('content')
  ...
  <nav aria-label="breadcrumb ">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Коршоям танга</li>
    </ol>
</nav>
...
<div class="row  mt-2" id="newg">
    ...
    <div class="col-md-1  ">
        ...
        <input      style="width: 05rem;" id="countg1" data-type="1"  type="text"  name="countg[] " class="form-control Somon count">
...
{{-- //25 diram --}}
<div class="tab-pane fade " id="TwintyFiveD" role="tabpanel" aria-labelledby="TwintyFiveD-tab"> 
        ...
        <div class="row  mt-2" id="newc">
            ...
            <div class="col-md-1  ">
                ...
                <input style="width: 05rem;" id="countc1" data-type="1" type="text" name="countc[]" class="form-control Somon count">
...
{{-- //1 Somoni --}}
<div class="tab-pane fade " id="OneS" role="tabpanel" aria-labelledby="OneS-tab"> 
        ...
        <div class="row  mt-2     " id="new00">
            ...
            <input id="nominal01" value="1" class="nominal" type="hidden" name="nominal0[]">
             ...
             <div class="col-md-1  ">
                 ...
                 <input style="width: 05rem;" id="count01" data-type="1" type="text" name="count0[]" class="form-control  Somon  count">
...
<div id="sum01" class="col-md-3 offset-8   " style="margin-top:-10px;"></div>
    ...
    {{-- //3 Somoni --}}
<div class="tab-pane fade " id="ThreeS" role="tabpanel" aria-labelledby="ThreeS-tab"> 
   ...
   <div class="row  mt-2" id="new31">
            ...
            <div class="col-md-1  ">
                ...
                <input style="width: 05rem;" id="count31"  data-type="1" type="text" name="count3[]" class="form-control Somon count">
...
<div id="nepolniySomon3">    </div>
    ...
    {{-- End 3 Somoni --}}
        {{-- // Somoni --}}
<div class="tab-pane fade " id="FiveS" role="tabpanel" aria-labelledby="FiveS-tab"> 
       ...
       <div class="row  mt-2" id="new51">
            ...
            <div class="col-md-1  ">
                ...
                <input style="width: 05rem;" id="count51" data-type="1" type="text" name="count5[]" class="form-control Somon count">
 ...
 <div class="tab-pane fade " id="FiveD" role="tabpanel" aria-labelledby="FiveD-tab"> 
                                        ...
                                        <div class="row  mt-2" id="newh">
                                            ...
                                            <div class="col-md-1  ">
                                                ...
                                                <input      style="width: 05rem;" id="counth1" data-type="1"  type="text"  name="counth[] " class="form-control Somon count">
                                      ...
                                      <div class="tab-pane fade " id="TwintyD" role="tabpanel" aria-labelledby="TwintyD-tab">  
                                        ...
                                        <div class="row  mt-2" id="newj">
                                            ...
                                            <div class="col-md-1  ">
                                                ...
                                                <input      style="width: 05rem;" id="countj1" data-type="1"   type="text"  name="countj[] " class="form-control Somon count">
                                      ...
                                      <div class="tab-pane fade " id="FiftyD" role="tabpanel" aria-labelledby="FiftyD-tab"> 
                                        <div class="row  mt-2" id="newk">
                                            ...
                                            <div class="col-md-1  ">
                                                ...
                                                <input      style="width: 05rem;" id="countk1"  data-type="1" type="text"  name="countk[] " class="form-control Somon count">
  ...
  {{--  Расход Модал--}}
  <form method="POST" action="{{route('korshoyam_tanga.store')}}">
    @csrf
...
<div class="modal fade" id="exampleModalCenter"  tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog  modal-xl" role="document">
      ...
      <div class="card col-md-6 mt-1 ml-4">
        <div class="card-body">
            <h4>Танга Коршоям</h4>
            ...
            <table class="table col-md-auto">
                ...
                //         exit;
                        ?>
                @foreach(json_decode($FondMoneyTang->take(50),true) as $korshoyamTanga)
...
var counts= '  <div class="col-md-1  "><label for="count'+idv+new_btn+'">Кол-во	</label><input      style="width: 05rem;" id="count'+idv+new_btn+'" data-type="1"   type="text"  name="count'+idv+'[]" class="form-control Somon  count"></div>';
  // ..Хранилище тег
