            ...
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#botilshudaR"  data-Context="botilshudaR"  id="priznak" value="1">Расход</button>
  ...
  {{-- //farsuda --}}
     ...
     <div class="modal fade" id="botilshudaP"  tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        @include('fonds.fondcancled.botilshudaPrihod')
          ...
          <div class="modal fade" id="botilshudaR"  tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitles" aria-hidden="true">
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-4 mt-4">
                        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                            <input type="radio" class="btn-check" name="src222" id=" " autocomplete="off" value="5" required>
                            <label class="btn btn-outline-secondary" for="btnradio1222">Душанбе</label>
                          
                            <input type="radio" class="btn-check" name="src2222" id=" " autocomplete="off" value="6" required>
                            <label class="btn btn-outline-secondary" for="btnradio222">Нобудкуни</label>
...
{{--                    Oborot table limit 20 //--}}
         ...
         @if($biks->id===array_map(function($value){return   $value['bik'];},$oborotsTanga)[0]>0)
                                    ...
                                    <div class="tab-pane fade " id="TwintyDTanga" role="tabpanel" aria-labelledby="TwintyDTanga-tab">  
                                        ...
                                        <div class="row  mt-2" id="neww">
                                            ...
                                            <div class="col-md-1  ">
                                                ...
                                                <input      style="width: 05rem;" id="countw1"   data-type="1" type="text"  name="countw[] " class="form-control Somon count">
...
<div class="row  mt-2" id="newq">
    ...
    <div class="col-md-1  ">
        ...
        <input      style="width: 05rem;" id="countq1" data-type="1"   type="text"  name="countq[] " class="form-control Somon count">
...
<div class="tab-pane fade " id="TwintyFiveDTanga" role="tabpanel" aria-labelledby="TwintyFiveD-tab"> 
          ...
          <div class="row  mt-2" id="newy">
            ...
            <div class="col-md-1  ">
                ...
                <input style="width: 05rem;" id="county1"  data-type="1" type="text" name="county[]" class="form-control Somon count">
...
<div class="tab-pane fade " id="TenDiram" role="tabpanel" aria-labelledby="TenDiram-tab"> 
    ...
    <div class="row  mt-2" id="new7">
      ...
      <div class="col-md-1  ">
          ...
          <input style="width: 05rem;" id="count71"   data-type="1" type="text" name="count7[]" class="form-control Somon count">
        ...
        <div class="row  mt-2     " id="newu">
            ...
            <input id="nominalu1" value="1" class="nominal" type="hidden" name="nominalu[]">
             ...
             <div class="col-md-1  ">
                 ...
                 <input style="width: 05rem;" id="countu1"  data-type="1" type="text" name="countu[]" class="form-control  Somon  count">
...
<div class="tab-pane fade " id="ThreeSTanga" role="tabpanel" aria-labelledby="ThreeS-tab"> 
   ...
   <div class="row  mt-2" id="newi1">
            ...
            <div class="col-md-1  ">
                <label for="count31">Кол-во	</label>
                <input style="width: 05rem;" id="counti1"  data-type="1" type="text" name="counti[]" class="form-control Somon count">
...
<div class="tab-pane fade " id="FiveSTanga" role="tabpanel" aria-labelledby="FiveS-tab"> 
       ...
       <div class="row  mt-2" id="newo1">
            ...
            <div class="col-md-1  ">
                ...
                <input style="width: 05rem;" id="counto1"  data-type="1" type="text" name="counto[]" class="form-control Somon count">
